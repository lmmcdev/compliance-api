...
// (Optional) CORS preflight for your routes
async function optionsHandler(): Promise<HttpResponseInit> {
  return {
    status: 204,
    headers: {
...
// optional CORS
app.http('optionsLicenseTypes', {
  methods: ['OPTIONS'],
  authLevel: 'anonymous',
  route: `${prefixRoute}`,
  handler: optionsHandler,
});
app.http('optionsLicenseTypeItem', {
  methods: ['OPTIONS'],
  authLevel: 'anonymous',
  route: `${itemRoute}`,
  handler: optionsHandler,
